if (navigator.serviceWorker) {
    window.addEventListener('load', () => {
	   navigator.serviceWorker.register('/hw4/service-worker.js')
...
function changeTheme(color) { 
    ...
    document.getElementsByTagName('body').style.backgroundImage = `url(/jeremychen212.github.io/hw4/images/${color}.jpg)`;
}